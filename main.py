...
if __name__ == '__main__':
    ...
    board = create_board('Test board from api 1', 'Test board from api desc 1')

    response_data = json.loads(board.content)

    board_id = response_data["resource_response"]["data"]["id"]

    pin = pinterest.pin(board_id=board_id, image_url='https://cdn.ezfunnels.com/landing/img/d8a0dae.png', description='Some pin desc', title='Some pin title')
